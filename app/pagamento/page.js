    ...
    <main className="">
      ...
      >
        <p className="text-4xl text-start flex ml-12 mt-6">
          Suas apólices estão associadas a suas formas de<br/> pagamento cadastradas.
        </p>
        ...
        <div className="flex flex-col mt-12 px-12 gap-12">
          ...
          >
            <Image src={plus} height={40} width={40} className='object-contain' />
          ...
          >
            <Image src={edit} height={40} width={40} className='object-contain' />
        ...
        >
          <p className="text-4xl m-12 mx-12 flex gap-5">
            Exibir todas 
            <Image src={toggle} height={90} width={90} className='object-contain' />
          </p>
        </motion.div>
      ...
      <div className='flex justify-center px-12 pb-8'>
        <Link href={"/extratoCompleto"}>
          ...
          >
            Extrato Completo
            <Image src={arrowRight} height={50} width={50} className='object-contain' />
          </motion.button>
        </Link>
      </div>
    </main>
