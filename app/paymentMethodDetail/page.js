...
export default function PaymentMethodDetail() {
	...
	const itemName =
		item.name === "Mastercard" ? "Mastercard Crédito" : item.name;
			...
			<section className="p-12">
				...
				>
					...
					<h1 className="font-bold text-5xl">
						Apólices associadas a esta <br /> forma de pagamento
					</h1>
				</motion.header>
				<div>
					{item.policies.map((policy, index) => (
						...
						>
							<div className="flex justify-between">
								<p className="text-4xl text-captions-heading font-bold">
									{policy.name}
								</p>
								<div className="border-green-dark border-2 bg-green-white rounded-lg w-min">
									<p className="text-4xl p-2 text-green-dark font-semibold">
										Pago
									</p>
								</div>
							</div>
