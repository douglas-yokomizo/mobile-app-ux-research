      ...
      <nav>
        <ul className="flex flex-col p-12">
          {[
            ...
            { href: "/", icon: acompanharSolucoes, text: "Acompanhar solicitação" },
            { href: "/", icon: apolices, text: "Apólices" },
            { href: "/", icon: atendimento, text: "Atendimento" },
            { href: "/", icon: beneficiarios, text: "Beneficiários" },
            { href: "/", icon: compartilhar, text: "Compartilhar e gerenciar acessos" },
            { href: "/dados-cadastrais", icon: dados, text: "Dados cadastrais" },
            ...
            >
              ...
              {index < 7 && <div className="border-b-2 border-gray-300 my-5"></div>}
            </motion.li>
          ))}
        </ul>
      </nav>
