  ...
  return (
    <main className="">
      ...
      <div className="flex justify-center">
        <button className="flex px-64 py-4 text-4xl gap-2 items-center text-blue-500 border-blue-500 border-2 rounded-full">
          {" "}
          <Image src={sair} width={40} height={40} /> Sair do aplicativo
        </button>
      </div>
      <div className="flex justify-center">
        <p className="flex my-8 text-4xl gap-2 items-center text-blue-500">
