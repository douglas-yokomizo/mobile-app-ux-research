...
export default function Enderecos() {
	...
	const [phoneNumber, setPhoneNumber] = useState("(21) 98213-2466");
	const [email, setEmail] = useState("jorgelinhares@email.com");
		...
		<div className="h-screen ">
			...
			<div className="flex flex-col gap-16 p-6 mt-32">
				...
				<Input
					...
					value={phoneNumber}
					onClick={() => {
						setPhoneNumber("(21) 98568-1148");
						setEmail("linhares.jorge@gmail.com");
